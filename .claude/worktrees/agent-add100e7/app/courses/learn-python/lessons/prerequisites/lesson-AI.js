...
Now that you understand how to use AI as a tool rather than a crutch,
it's time to set up your Python projects properly.

In the next lesson, you'll learn about virtual environments —
how to keep each project's packages isolated so they never conflict with each other.

When you're ready, continue to:

**1.7 Virtual Environments & venv**
`,
};
